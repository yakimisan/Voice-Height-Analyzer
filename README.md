...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/yakimisan/voice-height-estimator/blob/main/wavファイルの母音のｆ0から身長を推定.ipynb)
...
本ツールは音響学の理論に基づく統計的な推定であり、その精度を保証するものではありません。結果はあくまで参考値としてお楽しみください。発話内容、マイクの品質、環境ノイズによって結果は大きく変動します。
